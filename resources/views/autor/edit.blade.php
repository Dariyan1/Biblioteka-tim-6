...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form method="post" action="{{route('autor.update',$autor->id)}}" class="text-gray-700 forma">
                @csrf
                @method('PUT')
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="ImePrezime" id="imePrezimeAutorEdit" value="{{$autor->ImePrezime}}" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsImePrezimeAutorEdit()"/>
