                    ...
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[100px]">
                            ...
                            <div class="mt-[20px]">
                                ...
                                <input type="password" name="pwBibliotekarEdit" id="pwBibliotekarEdit" value="" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsPwBibliotekarEdit()"/>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <input type="password" name="pw2BibliotekarEdit" id="pw2BibliotekarEdit" value="" class="flex w-[90%] mt-2 px-2 py-2 text-base bg-white border border-gray-300 shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-[#576cdf]" onkeydown="clearErrorsPw2BibliotekarEdit()"/>
                       ...
                       <div class="mt-[50px]"> 
                            <label class="mt-6 cursor-pointer">
                                <div id="empty-cover-art" class="relative w-48 h-48 py-[48px] text-center border-2 border-gray-300 border-solid">
                                    ...
                                    <img src="@if($b->Foto){{ url('storage'.$b->Foto) }}@else /img/defaultusericon.jpg @endif" alt="nema slike" class="absolute w-48 h-[188px] bottom-0" />	
                                </div>
