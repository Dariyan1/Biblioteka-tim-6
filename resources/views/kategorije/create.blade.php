...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <form method="post" action="/storeKategorije" class="text-gray-700 forma" onsubmit="validacijaKategorije(event)">
                @csrf 
                                ...
                                <div id="empty-cover-art-ikonica" 
                                    ...
                                    <div class="bg-gray-300 h-[40px] w-[102px] px-[20px] pt-[10px]">
                                        <label class="cursor-pointer">
                                            ...
                                            <input id="icon-upload" name="ikonica" type='file' class="hidden" :multiple="multiple"
                                                :accept="accept" />
                                        </label>
                                    </div>
                        ...
                        <div class="flex flex-row">
                            <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                                <button type="button" 
                                    ...
                                    <a href= "/settingsKategorije">  Ponisti <i class="fas fa-times ml-[4px]"></i> </a>
                                </button>
