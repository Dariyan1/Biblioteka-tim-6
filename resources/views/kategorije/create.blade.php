...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form method="post" action="{{route('kategorije.store')}}" class="text-gray-700 forma" enctype="multipart/form-data">
                @csrf
                @method('POST')
                                ...
                                <div id="empty-cover-art-ikonica"
                                    ...
                                    <div class="bg-gray-300 h-[40px] w-[102px] px-[20px] pt-[10px]">
                                        <label class="cursor-pointer">
                                            ...
                                            <input id="icon-upload" name="ikonica" type='file' name="file" class="hidden" 
                                                :accept="accept" />
                                        </label>
                                    </div>
                        ...
                        <div class="flex flex-row">
                            <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                                <button type="button"
                                    ...
                                    <a href="{{route('kategorije.index')}}">Poništi<i class="fas fa-times ml-[4px]"></i></a>
                                </button>
