...
@section('content')
     ...
     <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <div class="scroll height-content section-content">
                <form method="post" action="{{route('format.update',$format->id)}}" class="text-gray-700 forma">
                   @csrf 
                   @method('PUT')
                    <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validateNazivFormatEdit">
                                @error('nazivFormatEdit')@php echo 'Naziv formata je obavezno polje.'; @endphp @enderror</div>
