...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <!-- Space for content onclick="validacijaKategorija()"  onkeydown="clearErrorsNazivKategorije()"-->
            <div class="scroll height-content section-content">
                <form action="{{route('kategorija.store')}}" method="post" class="text-gray-700 forma">
                    @csrf 
                    @method('POST')
                        ...
                        <div class="w-[50%] mb-[100px]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="nazivKategorije" id="nazivKategorije"
                                    ...
                                    />
                                <div class="fail" id="validateNazivKategorije">
                                @error('nazivKategorije')@php echo'Polje naziv kategorije je obavezno'; @endphp @enderror
                                </div>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validateNazivKategorije">
                                @error('opisKategorije')@php echo'Polje opis kategorije je obavezno'; @endphp @enderror</div>
                                </div>
                            </div>
                        </div>
                    </div>
