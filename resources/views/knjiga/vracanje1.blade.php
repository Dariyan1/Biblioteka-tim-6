            ...
            <div class="heading">
                <div class="flex flex-row justify-between border-b-[1px] border-[#e4dfdf]">
                    ...
                    <div class="pt-[24px] mr-[30px]">
                        ...
                        <a href="{{route('knjiga.izdaj',$knjiga->id)}}" class="inline hover:text-blue-600 ml-[20px] pr-[10px]">
                            ...
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="flex flex-row items-center px-4 py-4">
                                    ...
                                    <a href="ucenikProfile.php">
                                       ...
                                       {{$i->izdataOd($i->pozajmiokorisnik_id,$knjiga->id)->ImePrezime}}
                                        </span>
                                    </a>
                                </td>
                               ...
                               @else
                                ...
                                {{$i->zadrzavanje($i->id)['dana']}}

                               @endif
                                </td>
                                <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">
                               @if($i->prekoracenje($i->id)=='Nema prekoracenja')
                               Nema prekoracenja
                               @else
                               ...
                               {{$i->prekoracenje($i->id)}}      
                                ...
                                <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">  {{$i->izdato_od($i->id)[0]->ImePrezime}}</td>
                            </tr>
                           @endforeach
                        </tbody>
                    </table>
