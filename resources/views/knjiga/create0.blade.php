...
<section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <a  id="tab2" href="#"  class="moj  active-book-nav hover:text-blue-800 ">
                    Specifikacija
                </a>
               
                <a href="#" id="tab1"  class="moj inactive inline ml-[70px] hover:text-blue-800">
                    Osnovni detalji
                </a>
                ...
                <div class="flex flex-row ml-[30px] mb-[150px]">
                        <div class="w-[50%]">
                            <div class="mt-[20px]">
                                ...
                                <input type="text" name="nazivKnjiga" id="nazviKnjiga"
                            ...
                            @error('kategorije')@php echo'Naziv kategorije je obavezno polje'; @endphp @enderror
            ...
            <div class="mt-[20px]">
                ...
                @error('izdavac')@php echo'Izdavac knjige je obavezno polje'; @endphp @enderror
                </div>
            </div>
            ...
            <div class="mt-[20px]">
                ...
                <div class="fail" id="validateGodinaIzdavanja">
                @error('godina')@php echo'Godina izdavanja knjige je obavezno polje'; @endphp @enderror
                </div>
            </div>
            ...
            <div class="mt-[20px]">
                ...
                <input type="text" name="knjigaKolicina" id="knjigaKolicina"
                    ...
                    />
                <div class="fail" id="validateKnjigaKolicina">
                 ...
                 <div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            ...
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validatePismo">
                                @error('pismo')@php echo'Godina izdavanja knjige je obavezno polje'; @endphp @enderror
                                </div>
                            </div>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validatePovez">
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="format" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="format" id="format" onclick="clearErrorsFormat()">
                                <option></option>
                            ...
                            <div class="mt-[20px]">
                                ...
                                @error('isbn')@php echo'ISBN knjige je obavezno polje'; @endphp @enderror
                                </div>
                            </div>
                        </div>
                    </div>
