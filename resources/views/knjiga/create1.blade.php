...
@section('content')
     ...
     <section class="w-screen h-screen pl-[80px] pb-4 text-gray-700">
            ...
            <!-- Space for content onkeydown="clearErrorsNazivKnjiga()" onclick="clearErrorsKategorija()" onclick="clearErrorsZanr()"-->
            <div class="scroll height-content section-content">
                <form  action="{{route('knjiga.store')}}" method="post"  class="text-gray-700 forma">
                @csrf
                @method('POST')
                    <div class="flex flex-row ml-[30px] mb-[150px]">
                        <div class="w-[50%]">
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validateNazivKnjiga">
                                 @error('nazivKnjiga')@php echo "Naziv knjige je obavezno polje"; @endphp @enderror
                                 </div>
                            </div>
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="kategorijaKnjige" x-cloak id="kategorija">
                                <option></option>
                                ...
                                <div x-data="dropdown()" x-init="loadOptions()" class="flex flex-col w-[90%]">
                                    <input name="kategorije" id="kategorijaInput" type="hidden"
                            ...
                            <div class="fail" id="validateKategorija">
                            @error('kategorije')@php echo "Kategorija knjige je obavezno polje"; @endphp @enderror
                        ...
                        <div class="mt-[20px]">
                            ...
                            <div x-data="dropdown()" x-init="loadOptionsZanrovi()" class="flex flex-col w-[90%]">
                                <input name="zanrovi" id="zanroviInput" type="hidden" x-bind:value="selectedValues()">
                                <div class="relative inline-block w-[100%]">
                                    <div class="relative flex flex-col items-center">
                                        <div x-on:click="open" class="w-full svelte-1l8159u">
                                            <div class="flex p-1 my-2 bg-white border border-gray-300 shadow-sm svelte-1l8159u focus-within:ring-2 focus-within:ring-[#576cdf]"
                        ...
                        <div class="fail" id="validateZanr">
                        @error('zanrovi')@php echo "Zanr knjige je obavezno polje"; @endphp @enderror
            ...
            <div class="w-[50%]">
                <div class="mt-[20px]">
                    ...
                    <div x-data="dropdown()" x-init="loadOptionsAutori()" class="flex flex-col w-[90%]">
                        <input name="autori" id="autoriInput" type="hidden" x-bind:value="selectedValues()">
                        <div class="relative inline-block w-[100%]">
                            <div class="relative flex flex-col items-center">
                                <div x-on:click="open" class="w-full svelte-1l8159u">
                                    <div class="flex p-1 my-2 bg-white border border-gray-300 shadow-sm svelte-1l8159u focus-within:ring-2 focus-within:ring-[#576cdf]"
                ...
                <div class="fail" id="validateAutori">
            ...
            <div class="mt-[20px]">
                ...
                <div class="fail" id="validateIzdavac">
                @error('izdavac')@php echo "Naziv izdavača je obavezno polje"; @endphp @enderror
            ...
            <div class="mt-[20px]">
                ...
                <select
                    class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]"
                    name="godina" id="godinaIzdavanja" >
                    <option></option>
                    @for($i=1950;$i<=2060;$i++)
                    <option value="{{$i}}">
                        {{$i}}
                ...
                <div class="fail" id="validateNazivKnjiga">
                 @error('godina') @php echo "Godina izdavanja je obavezno polje"; @endphp @enderror
                 </div>
            </div>
            ...
            <div class="mt-[20px]">
                ...
                <div class="fail" id="validateNazivKnjiga">
                                 @error('knjigaKolicina')@php echo "Kolicina knjiga je obavezno polje"; @endphp @enderror
                                 </div>
...
<div class="flex flex-row ml-[30px]">
                        <div class="w-[50%] mb-[150px]">
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validateBrStrana">
                                @error('brStrana')@php echo "Broj strana je obavezno polje"; @endphp @enderror
                                </div>
                            </div>

                            <div class="mt-[20px]">
                                <p>Pismo <span class="text-red-500">*</span></p>
                                <select name="pismo" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="pismo" id="pismo" onclick="clearErrorsPismo()">
                                <option></option>
                               ...
                               @endforeach
                                ...
                                @error('pismo')@php echo "Pismo je obavezno polje"; @endphp @enderror
                ...
                <div class="mt-[20px]">
                 ...
                 <!-------kraj dodajemo jezik --->
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="povez" class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="povez" id="povez" onclick="clearErrorsPovez()">
                                <option></option>
                               ...
                               @endforeach
                                ...
                                <div class="fail" class="povez" id="validatePovez">
                                @error('povez')@php echo "Povez je obavezno polje"; @endphp @enderror
                            ...
                            <div class="mt-[20px]">
                                ...
                                <select name="format" class class="flex w-[45%] mt-2 px-2 py-2 border bg-white border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#576cdf]" name="format" id="format" >
                                <option>   </option>
                               ...
                               @endforeach
                                ...
                                <div class="fail" id="validateFormat">
                                @error('format')@php echo "Format je obavezno polje"; @endphp @enderror
                            ...
                            <div class="mt-[20px]">
                                ...
                                <div class="fail" id="validateIsbn">
                                @error('isbn')@php echo "ISBN je obavezno polje"; @endphp @enderror
...
<!----------------------------------end multimedija------------------------------------->
        ...
        <!-- End Content onclick="clearErrorsIzdavac()" onclick="clearErrorsFormat()" onclick="clearErrorsAutori()" onkeydown="clearErrorsKnjigaKolicina()"  onclick="validacijaKnjiga()" onclick="clearErrorsGodinaIzdavanja()"-->
@endsection