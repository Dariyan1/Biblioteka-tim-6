                                ...
                                <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                    ...
                                    <td class="flex flex-row items-center px-4 py-4">
                                        ...
                                        <a href="knjigaOsnovniDetalji.php">
                                            <span class="font-medium text-center">{{$k->naslov}}</span>
                                        </a>
                                    </td>
                                    ...
                                    <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">{{$k->ukupnoPrimjeraka}}</td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
                                            href="aktivneRezervacije.php">{{$k->rezervisanoPrimjeraka}}</a></td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
                                            href="izdateKnjige.php">{{$k->izdatoPrimjeraka}}</a></td>
                                    <td class="px-4 py-4 text-sm leading-5 text-blue-800 whitespace-no-wrap"><a
