...
<section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
    ...
    <div class="py-4 text-gray-500 border-b-[1px] border-[#e4dfdf] pl-[30px]">
        ...
        <a href="settings" class="inline hover:text-blue-800 active-book-nav" >
            Polisa
        </a>
        <a href="kategorije" class="inline ml-[70px] hover:text-blue-800">
            Kategorije
        </a>
        <a href="zanrovi" class="inline ml-[70px] hover:text-blue-800 ">
            Žanrovi
        </a>
        <a href="izdavac" class="inline ml-[70px] hover:text-blue-800">
            Izdavač
        </a>
        <a href="povez" class="inline ml-[70px] hover:text-blue-800">
            Povez
        </a>
        <a href="format" class="inline ml-[70px] hover:text-blue-800">
            Format
        </a>
